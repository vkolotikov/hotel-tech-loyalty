    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-[#8e8e93]">Configure how your AI assistant behaves and responds to guests</p>
        </div>
      </div>
      ...
      {isLoading ? (
        <div className="text-center text-[#8e8e93] py-12">Loading configuration...</div>
      ) : tab === 'behavior' ? (
        /* ═══ BEHAVIOR TAB ═══ */
        <div className="space-y-6">
          {/* Identity Section */}
          <div className="bg-dark-surface border border-dark-border rounded-xl p-6 space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm text-[#8e8e93] mb-1">Assistant Name</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm text-[#8e8e93] mb-1">Language</label>
                <input
                  type="text"
            ...
            <div>
              <label className="block text-sm text-[#8e8e93] mb-1">Identity / Persona</label>
              <textarea
            ...
            <div>
              <label className="block text-sm text-[#8e8e93] mb-1">Goal</label>
              <textarea
                value={bForm.goal || ''}
          ...
          <div className="bg-dark-surface border border-dark-border rounded-xl p-6 space-y-4">
            ...
            <div>
              <label className="block text-sm text-[#8e8e93] mb-2">Sales Style</label>
                  ...
                  <button
                    ...
                    className={`p-3 rounded-lg border text-left transition-colors ${
                      (bForm.sales_style || 'consultative') === s.value
                        ...
                        : 'border-dark-border hover:border-[#555]'
                    }`}
                  >
                    <div className="text-sm font-medium text-white">{s.label}</div>
                    <div className="text-xs text-[#8e8e93] mt-1">{s.desc}</div>
                  </button>
                ))}
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm text-[#8e8e93] mb-1">Tone</label>
                <select
              ...
              <div>
                <label className="block text-sm text-[#8e8e93] mb-1">Reply Length</label>
                    ...
                    <button
                      ...
                      className={`flex-1 py-2 px-3 rounded-lg border text-sm transition-colors ${
                        (bForm.reply_length || 'moderate') === r.value
                          ...
                          : 'border-dark-border text-[#8e8e93] hover:border-[#555]'
                      }`}
                    >
                      {r.label}
                    </button>
          ...
          <div className="bg-dark-surface border border-dark-border rounded-xl p-6 space-y-4">
            ...
            <p className="text-sm text-[#8e8e93]">Rules the assistant must always follow</p>

            <div className="space-y-2">
              {(bForm.core_rules || []).map((rule: string, i: number) => (
                <div key={i} className="flex items-center gap-2 bg-[#1c1c1e] rounded-lg px-3 py-2">
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 bg-[#1c1c1e] border border-dark-border rounded-lg px-3 py-2 text-white text-sm"
          ...
          <div className="bg-dark-surface border border-dark-border rounded-xl p-6 space-y-4">
            ...
            <div>
              <label className="block text-sm text-[#8e8e93] mb-1">Escalation Policy</label>
              <textarea
            ...
            <div>
              <label className="block text-sm text-[#8e8e93] mb-1">Fallback Message</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-sm text-[#8e8e93] mb-1">Custom Instructions</label>
              <textarea
        ...
        <div className="space-y-6">
          <div className="bg-dark-surface border border-dark-border rounded-xl p-6 space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm text-[#8e8e93] mb-1">Provider</label>
                <select
              ...
              <div>
                <label className="block text-sm text-[#8e8e93] mb-1">Model</label>
                <select
          ...
          <div className="bg-dark-surface border border-dark-border rounded-xl p-6 space-y-5">
            ...
            <div>
              <div className="flex justify-between text-sm mb-1">
                <span className="text-[#8e8e93]">Top P</span>
            ...
            <div>
              <div className="flex justify-between text-sm mb-1">
                <span className="text-[#8e8e93]">Max Tokens</span>
            ...
            <div>
              <div className="flex justify-between text-sm mb-1">
                <span className="text-[#8e8e93]">Frequency Penalty</span>
            ...
            <div>
              <div className="flex justify-between text-sm mb-1">
                <span className="text-[#8e8e93]">Presence Penalty</span>

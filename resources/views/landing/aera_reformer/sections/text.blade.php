{{--
  ...
  ASSEMBLED FROM THE AUTHOR'S OWN PARTS, deliberately: the split
  `.section-heading` his sessions band uses — eyebrow and display heading on
  the left, the opening paragraph on the right — then the prose in his body
  face, and a photograph in his radius and shadow. Drawing a NEW composition
  would mean new CSS in a stylesheet whose whole contract is that it is the
  author's file; the rules this band adds are a reading measure for the prose
  and the frame, and they are in the appended tenant-state block with their
  reason beside them.

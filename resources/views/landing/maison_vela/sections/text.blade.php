{{--
  A tenant-added words band (data-block="text", data-variant="house-note").
  ...
  ASSEMBLED FROM THE AUTHOR'S OWN PARTS, deliberately: the three-column
  section header his menus band already uses, his muted prose voice, and a
  plate cropped the way his kitchen photograph is. Drawing a NEW composition
...
@endphp
    <section class="text-band section container" id="{{ $section->key }}" data-block="text" data-variant="house-note">

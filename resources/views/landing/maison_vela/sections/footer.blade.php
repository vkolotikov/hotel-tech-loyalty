{{--
  The maître d' hub (data-block="footer", data-variant="maitre-d-hub").
...
@php
    ...
    // instead — "Tue–Sat dinner · Fri–Sun lunch" — which is a claim only the
...
@endphp
  <footer class="site-footer" id="site-footer" data-block="footer" data-variant="maitre-d-hub">
...
@if (filled($chatFrameUrl ?? null))
        ...
        <iframe class="ai-panel" id="vela-chat-panel" src="{{ $chatFrameUrl }}"
        ...
        <button class="ai-launcher" type="button"
                aria-controls="vela-chat-panel" aria-expanded="false"
...
@endif
    ...
    <div class="container footer-bottom">
      {{-- THE LEGAL LINE. The author's is "© 2026 Maison Vela. Fictional

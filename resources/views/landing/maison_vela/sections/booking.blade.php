{{--
  ...
  honestly fill. A restaurant on this template therefore closes on the
  footer's contact hub instead — which is exactly where its fixed Reserve pill
  already points. This partial does not second-guess that: it is only included

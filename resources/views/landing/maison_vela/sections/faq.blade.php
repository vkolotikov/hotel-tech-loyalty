{{--
  Before your table (data-block="faq", data-variant="dining-essentials").

  The author's split on the paper-deep band: an intro column — eyebrow and
...
@php
    ...
    $title = $heading !== '' ? $heading : ($kicker !== '' ? $kicker : __('The useful details'));
@endphp
    <section class="faq section" id="faq" data-block="faq" data-variant="dining-essentials" aria-labelledby="faq-title">

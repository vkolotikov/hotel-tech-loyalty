{{--
  ...
  a veil in his own overlay token, his `<h3>` as the photograph's caption and
  his `<p>` — the line of prose under the name — as the caption's note
  (`caption_N_note`, printed exactly where he drew it and only when the tenant
  has written one). The band is exactly the height he drew it at every count,
  and the stylesheet's appended block carries that rule with the same
  reasoning.

{{--
  The quiet offer (data-block="announcement", data-variant="service-note").
...
@endphp
  <aside class="announcement" data-block="announcement" data-variant="service-note" aria-label="{{ __('Current offer') }}">

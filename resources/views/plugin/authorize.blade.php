...
<main>
    ...
    <ul>
        <li>Read CRM leads, their requirements, recorded proposals and linked chatbot messages.</li>
        <li>Prepare email proposal drafts in ChatGPT for your review; this connection cannot send email.</li>
        <li>Change a lead's CRM status when you request it, with an audit record.</li>

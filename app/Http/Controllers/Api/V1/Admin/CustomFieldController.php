        ...
        foreach (CustomFieldService::PRESETS as $key => $defs) {
            ...
            $list[] = [
                ...
                'description' => match ($key) {
                    ...
                    'legal'       => 'Matter type, conflict check, case type, deadlines, retainer, fee arrangement.',
                    'real_estate' => 'Buyer/seller, mortgage status, property type, budget range, must-haves, decision timeline.',

            ...
            [
                ...
                'articles' => [
                    ...
                    [
                        ...
                        'content' => "To go live with reviews for a hotel:\n\n1. **Integrations** — Reviews > Integrations: paste the org's public URLs for Google reviews, TripAdvisor, Trustpilot. These are what the threshold-redirect points to.\n2. **Create a default Basic form** — set intro text, thank-you text, `redirect_threshold` (recommend 4★), and redirect prompt (e.g. \"Loved your stay? Share it publicly:\").\n3. **(Optional) Custom form** — if you want a deeper post-stay survey with NPS / multi-choice, build it separately.\n4. **Enable auto-send** — on the default form, tick *Auto-send after guest checkout* and pick a delay (3 or 7 days is typical). Confirm `app.url` in `.env` is correct — invitation links are built from it.\n5. **Smoke test** — use the one-off send button from any booking detail page to yourself, walk through the link, submit, confirm the invitation row lands in the funnel as *Submitted*.",
                    ],
                ],
            ],
            [

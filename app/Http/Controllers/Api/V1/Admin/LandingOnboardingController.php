...
class LandingOnboardingController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $data = $request->validate([
            ...
            // D6 (landing phase 3c): the per-key theme rules that used to
            // live here as sibling dotted rules moved to
            // App\Landing\ThemeRules, validated below as its OWN Validator
            // instance rather than dotted keys added to THIS array -- see
            // ThemeRules::validate()'s docblock for why (the phase-3a
            ...
            // and D6 needs an unrecognised key to 422, not to vanish
            // quietly).
        ...
        // (a stray `theme.whatever`, or the retired `theme.palette`) is
        // refused with a 422 rather than silently dropped.

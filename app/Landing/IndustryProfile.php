...
final class IndustryProfile
{
    ...
    /**
     * The mono eyebrow a band wears — the small-caps label every kit sets
     * over its display heading, and the page's own index when read top to
     * bottom: THE MENU / THE STUDIO / WHO YOU’LL SEE / IN THEIR WORDS /
     * RESERVE / FINDING US.
     *

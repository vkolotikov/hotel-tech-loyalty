...
return new class extends Migration
{
    public function up(): void
    {
        if (!Schema::hasTable('email_templates')) {
            Schema::create('email_templates', function (Blueprint $table) {
                ...
                $table->string('category', 50)->default('campaign');
        ...
        // Add email support columns to notification_campaigns if missing
        if (Schema::hasTable('notification_campaigns') && !Schema::hasColumn('notification_campaigns', 'email_template_id')) {
    ...
    {
        if (Schema::hasColumn('notification_campaigns', 'email_template_id')) {
            Schema::table('notification_campaigns', function (Blueprint $table) {
